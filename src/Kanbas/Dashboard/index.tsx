...
function Dashboard({ courses, course, setCourse, addNewCourse,
  ...
  console.log("Faculty or Admin",currentUserRole )
   const isAdminOrFaculty= (currentUserRole === "ADMIN") || (currentUserRole === "FACULTY");
  //  const isAdminOrFaculty=  currentUserRole === "FACULTY";

  console.log(isAdminOrFaculty)
  ...
  useEffect(() => {
    ...
    return (
      <div className="p-4">
        ...
        <h2>{isAdminOrFaculty ? "Published Courses" : "Available Courses"}</h2>
        </div>
        <div className="row">
